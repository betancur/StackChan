...
void AppClaudeBuddy::createUi()
{
    ...
    _clock_time->setTextFont(&FredokaClock76);  // rounded digits, generated by lv_font_conv
    _clock_time->setTextColor(lv_color_hex(THEME_PRIMARY));
    _clock_time->setText("00:00");  // the font only has digits and ':'
    _clock_time->align(LV_ALIGN_CENTER, 0, -16);
    lv_obj_set_style_text_letter_space(_clock_time->get(), 2, 0);
    ...
    _clock_date->setText("");
    _clock_date->align(LV_ALIGN_CENTER, 0, 44);
