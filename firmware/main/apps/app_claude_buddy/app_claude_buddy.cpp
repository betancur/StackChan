...
void AppClaudeBuddy::createUi()
{
    ...
    _clock_time->setTextFont(&FredokaClock100);  // rounded digits, generated by lv_font_conv
    _clock_time->setTextColor(lv_color_hex(CLOCK_COLOR));
    _clock_time->setText("00:00");  // the font only has digits and ':'
    _clock_time->align(LV_ALIGN_CENTER, 0, -12);
    lv_obj_set_style_text_letter_space(_clock_time->get(), 1, 0);
    ...
    _clock_date->setText("");
    _clock_date->align(LV_ALIGN_CENTER, 0, 62);
