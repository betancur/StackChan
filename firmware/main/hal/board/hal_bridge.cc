...
static constexpr std::string_view _xiaozhi_config_start_roz_on_boot_key            = "boot_roz";
...
XiaozhiConfig_t get_xiaozhi_config()
{
    ...
    config.startRozOnBoot =
        settings.GetBool(_xiaozhi_config_start_roz_on_boot_key.data(), config.startRozOnBoot);
...
void set_xiaozhi_config(const XiaozhiConfig_t& config)
{
    ...
    settings.SetBool(_xiaozhi_config_start_roz_on_boot_key.data(), config.startRozOnBoot);
}
